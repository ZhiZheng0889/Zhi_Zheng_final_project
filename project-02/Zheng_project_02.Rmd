...
enhanced_plot_revised <- ggplot() +
  ...
  theme(
    ...
    plot.title.position = "plot",
    plot.title = element_text(hjust = 0.5, size = 16, face = "bold", margin = margin(t = 10, b = 10)),
...
interactive_plot <- ggplotly(enhanced_plot, tooltip = "text") %>%
  layout(
    ...
    title = list(
      ...
      pad = list(b = 10)                # Adjust bottom padding
    ),
    legend = list(
      x = 1,
      y = 0.5,
...
interactive_plot_revised <- ggplotly(enhanced_plot_revised, tooltip = "text")  # Ensure tooltips are activated
